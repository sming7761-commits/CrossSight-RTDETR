...
# ===================== 路径配置 =====================
BASELINE_WEIGHTS = r"C:\Users\symin\Desktop\知识蒸馏\基线200轮\train\baseline_200_clean\weights\best.pt"

# 注意：这个是 B+C 权重，不是单独 ABC 权重
BC_WEIGHTS = r"C:\Users\symin\Desktop\知识蒸馏\完整\RTDETR\runs\train\rtdetr_r18_hfgmf_iswiou_200_b4\weights\best.pt"

SOURCE_DIR = r"C:\Users\symin\Desktop\FIG\VD"

OUT_DIR = r"C:\Users\symin\Desktop\FIG\vis_out_ABC_A640"
